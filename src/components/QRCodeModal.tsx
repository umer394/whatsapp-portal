          ...
          {qrData?.connected ? (
            ...
            <>
              ...
              <p className="mb-3 text-center text-sm text-gray-600">
                ...
                <a href="#" className="block text-center text-[#00a884] hover:underline text-xs mt-0.5">
                  Learn more
                </a>
              </p>
            </>
            ...
            <ol className="space-y-1.5 text-sm text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span className="flex items-center">
                  Open 
                  <span className="inline-flex items-center mx-1 bg-[#25D366] text-white rounded px-1 text-xs">
